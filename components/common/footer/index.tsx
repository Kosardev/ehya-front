...
export default async function Footer() {
    ...
    return (
        <footer className={'w-full bg-gray-2 font-yekanBakh text-white '}>
            <BaseContainer>
                <div className={'w-full border-b border-b-white px-2 lg:px-0 py-6 3xl:py-11 flex flex-col lg:flex-row items-center '}>
                    <figure className={'w-full lg:w-fit justify-center lg:justify-start flex items-center gap-1 ml-1 lg:ml-7'}>
                        {/*<AspectRatio aspect={60 / 70}>*/}
                            ...
                            />
                        {/*</AspectRatio>*/}
                        <figcaption className={'flex flex-col gap-0.5 font-yekanBakhEn font-light text-xs grow lg:grow-0 lg:text-base'} >
                            <p>احیا درمان پیشرفته</p>
                            <p>Ehya Darman Pishrafte</p>
                        </figcaption>
                    </figure>
                    <p className={'my-2 lg:my-0 lg:max-w-[50%] text-xs 2xl:text-sm font-light '} >شرکت احیا درمان پیشرفته اولین تولید کننده دستگاه های ونتیلاتور مراقبت ویژه و دستگاه های ماشین بیهوشی، تنها تولید کننده دستگاه های ونتیلاتور مراقبت ویژه و همچنین تولید کننده دستگاه CT Scan در ایران می باشد.
                    </p>
            ...
            <p className={'bg-black w-full flex items-center justify-center font-light py-2 text-xs 2xl:text-sm '}>
